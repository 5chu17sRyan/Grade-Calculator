...
public class Grader
{
     ...
     *                      Participation...).
     * @param criteriaSize Keeps track of how many elements are stored in the criteriaInput array. The value
     ...
     */
    public Grader(String[] criteriaInput, int criteriaSize, int[] weightInput, int[] scaleInput)
    {
        ...
        //grades
        gradeHolder = new double[MAX_GRADING_CRITERIA][70];
    }
    ...
    public void inputNewGrades()
    {
        ...
        for(int i = 0; i <= criteriaLength; i++)
        {
            ...
            while(GradeIn.hasNextDouble())
            {
                //Stores the next grade input in the variable newGrade
                double newGrade = GradeIn.nextDouble();
                /*
